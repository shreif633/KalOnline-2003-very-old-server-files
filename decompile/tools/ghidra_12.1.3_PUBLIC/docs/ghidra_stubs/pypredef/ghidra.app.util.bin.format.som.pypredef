...
class SomException(java.lang.Exception):
    """
    ...
    def __init__(self, cause: java.lang.Exception) -> None:
        ...
        :param java.lang.Exception cause: the cause (which is saved for later retrieval by the :meth:`getCause() <.getCause>`
...
class SomHeader(ghidra.app.util.bin.StructConverter):
    ...
    def __init__(self, reader: ghidra.app.util.bin.BinaryReader) -> None:
        ...
        :param ghidra.app.util.bin.BinaryReader reader: A :obj:`BinaryReader` positioned at the start of the header
        :raises SomException: if the header is invalid
        :raises IOException: if there was an IO-related error
        """
...
__all__ = ["SomAuxHeader", "SomAuxId", "SomAuxHeaderFactory", "SomCompilationUnit", "SomSysClock", "SomConstants", "SomDltEntry", "SomDynamicLoaderHeader", "SomShlibListEntry", "SomImportEntry", "SomExportEntry", "SomDynamicRelocation", "SomPltEntry", "SomExportEntryExt", "SomModuleEntry", "SomException", "SomExecAuxHeader", "SomHeader", "SomSpace", "SomSubspace", "SomSymbol", "SomLinkerFootprintAuxHeader", "SomProductSpecificsAuxHeader", "SomUnknownAuxHeader"]
