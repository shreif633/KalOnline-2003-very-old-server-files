...
class Exporter(ghidra.util.classfinder.ExtensionPoint):
    ...
    def canExportDomainFile(self, domainFile: ghidra.framework.model.DomainFile) -> bool:
        ...
        :meth:`export(File, DomainFile, TaskMonitor) <.export>` method.  All exporters capable of a 
        :obj:`DomainFile` export must also support an export of a :obj:`DomainObject` so that any
    ...
    def canExportDomainObject(self, domainObjectClass: java.lang.Class[ghidra.framework.model.DomainObject]) -> bool:
        ...
        export other :obj:`DomainFile` or :obj:`DomainObject` types such as project data type 
        archives.
        ...
        :meth:`export(File, DomainFile, TaskMonitor) <.export>` method which may avoid opening the file first.
...
class AsciiExporter(ProgramExporter):
    """
...
class ProgramExporter(Exporter):
    """
    :obj:`ProgramExporter` provides an abstract :obj:`Exporter` implementation for
    :obj:`Program` objects.
    """
...
class BinaryExporter(ProgramExporter):
    """
...
class HtmlExporter(ProgramExporter):
    """
    An implementation of exporter that creates
...
class IntelHexExporter(ProgramExporter):
    """
...
class OriginalFileExporter(ProgramExporter):
    """
...
class XmlExporter(ProgramExporter):
    """
    An implementation of exporter that creates
...
class CppExporter(ProgramExporter):
...
__all__ = ["Exporter", "ExporterException", "AbstractLineDispenser", "AsciiExporter", "ProgramExporter", "ProgramTextOptions", "BinaryExporter", "CommentLineDispenser", "GdtExporter", "GzfExporter", "HtmlExporter", "IntelHexExporter", "OriginalFileExporter", "ProgramTextWriter", "ReferenceLineDispenser", "StringComparer", "XmlExporter", "CppExporter"]
