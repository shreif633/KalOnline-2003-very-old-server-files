...
class GztExporter(ghidra.app.util.exporter.Exporter):

    class_: typing.ClassVar[java.lang.Class]
    EXTENSION: typing.Final = "gzt"
    SUFFIX: typing.Final = ".gzt"
    NAME: typing.Final = "Ghidra Trace Zip File"
...
class GztLoader(ghidra.app.util.opinion.Loader):
    """
    Loads a packed Ghidra Trace file.
    """

    class_: typing.ClassVar[java.lang.Class]
    GZT_NAME: typing.Final = "GZT Input Format"
...
__all__ = ["DebouncedRowWrappedEnumeratedColumnTableModel", "BackgroundUtils", "AbstractMappedMemoryBytesVisitor", "DefaultTransactionCoalescer", "TransactionCoalescer", "GztExporter", "GztLoader", "ManagedDomainObject", "MiscellaneousUtils", "ProgramLocationUtils", "ProgramURLUtils"]
