...
class SymbolUtilities(java.lang.Object):
    ...
    class BadCharFixupFunc(java.lang.Object):
        """
        Callback functional interface, called by 
        :meth:`SymbolUtilities.replaceInvalidChars(String, BadCharFixupFunc) <SymbolUtilities.replaceInvalidChars>` when it encounters a
        ...
        def fixBadChar(self, origIndex: typing.Union[jpype.JInt, int], badCodePoint: typing.Union[jpype.JInt, int]) -> str:
            ...
    ...
    USE_UNDERSCORES: typing.Final[SymbolUtilities.BadCharFixupFunc]
    """
    BadCharFixupFunc that replaces bad characters with '_' underscores
    """

    OMIT_BAD_CHARS: typing.Final[SymbolUtilities.BadCharFixupFunc]
    """
    ...
    def isInvalidChar(c: typing.Union[jpype.JChar, int, str]) -> bool:
        ...
        See :meth:`isInvalidCodePoint(int) <.isInvalidCodePoint>` for better method that uses code points instead of
        chars.
    ...
    @staticmethod
    def isInvalidCodePoint(cp: typing.Union[jpype.JInt, int]) -> bool:
        """
        Returns true if the specified code point is not valid for use in a symbol name.
        
        :param jpype.JInt or int cp: the code point to be tested as a valid symbol character.
    ...
    def replaceInvalidChars(str: typing.Union[java.lang.String, str], replaceWithUnderscore: typing.Union[jpype.JBoolean, bool]) -> str:
        ...
        :param java.lang.String or str str: String to fix, ``null`` ok
        :param jpype.JBoolean or bool replaceWithUnderscore: - true means replace the invalid chars with underscores, else
            if false, then just drop the invalid chars
        :return: either the original String instance if already valid (or ``null``), or a new
    ...
    @staticmethod
    @typing.overload
    def replaceInvalidChars(str: typing.Union[java.lang.String, str], badCharFixup: SymbolUtilities.BadCharFixupFunc) -> str:
        """
        Converts a string with possible invalid characters into a valid symbol string.
        
        :param java.lang.String or str str: String to fix, ``null`` ok
        :param SymbolUtilities.BadCharFixupFunc badCharFixup: callback that controls how each bad char is fixed.  It should return
        a string that should be used in place of the invalid character, or ``null`` if nothing
        should be used.
        :return: either the original String instance if already valid (or ``null``), or a new
