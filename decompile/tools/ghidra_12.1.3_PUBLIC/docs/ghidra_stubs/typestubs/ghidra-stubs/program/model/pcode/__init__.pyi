...
class Encoder(java.lang.Object):
    ...
    @typing.overload
    def writeOpcode(self, attribId: AttributeId, opcode: typing.Union[jpype.JInt, int]) -> None:
        """
        Write a p-code operation opcode into the encoding, given the opcode ordinal, defined in :obj:`PcodeOp`
        
        :param AttributeId attribId: is the attribute to associate with the opcode
        :param jpype.JInt or int opcode: is the opcode ordinal
        :raises IOException: for errors in the underlying stream
        """
