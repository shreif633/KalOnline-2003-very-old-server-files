...
class ElfSymbolNameUtils(java.lang.Object):
    ...
    @staticmethod
    def getBadElfSymbolStringCodePointReplacement(index: typing.Union[jpype.JInt, int], cp: typing.Union[jpype.JInt, int]) -> str:
        """
        Returns a replacement value for any bad code points found in an Elf symbol string.
        
        :param jpype.JInt or int index: index of the bad code point in the original string
        :param jpype.JInt or int cp: the bad code point
        :return: replacement value to use instead of the bad code point
        :rtype: str
        """

    @staticmethod
    def replaceInvalidChars(str: typing.Union[java.lang.String, str]) -> str:
        """
        Converts a string with possible invalid characters into a valid symbol string.
         
        
        See :meth:`getBadElfSymbolStringCodePointReplacement(int, int) <.getBadElfSymbolStringCodePointReplacement>`
        
        :param java.lang.String or str str: symbol string to fix, null ok
